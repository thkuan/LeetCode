...
int *postorder_traversal(tree_node_t *root, int *size) {
    tree_node_t *cur = root;
    stack_node_t *s = NULL;
    stack_node_t *s_print = NULL;
...
int main()
{
    ...
    ptr = postorder_traversal(root, &size);
